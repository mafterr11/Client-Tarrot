...
const Header = () => {
  return (
    <div className="fixed left-0 right-0 top-0 z-50 w-full border-b-[0.5px] border-black/50 bg-gradient-to-t from-[#91221E]/25 to-[#030202]/25 py-[12px] filter backdrop-blur-md transition-all duration-100 ease-in-out max-md:px-[25px] md:max-xl:px-[40px] xl:px-[55px]">
