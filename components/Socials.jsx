...
const Socials = ({ containerStyles }) => {
  return (
    ...
    >
      ...
      >
        <BiPhone size={35} />{" "}
        <span className="text-[16px] text-xl text-accent">Sunati-ma</span>
      </a>
      <a
      ...
      >
        ...
        <span className="text-[16px] text-xl text-accent">Lasati un mesaj</span>
      </a>
      <Link
      ...
      >
        ...
        <span className="text-[16px] text-xl text-accent">Youtube</span>{" "}
      </Link>
    </div>
  );
};
