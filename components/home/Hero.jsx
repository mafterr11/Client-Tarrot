...
const Hero = () => {
  return (
    <div className="relative flex h-screen w-screen flex-col items-center justify-start bg-hero bg-cover bg-center bg-no-repeat max-xl:justify-center xl:flex-row">
      {/* Black overlay */}
      ...
      <div className="relative z-30 max-xl:text-center max-xl:pt-20 xl:p-36">
        <h4 className="hero__subtitle font-semibold text-accent">
          Îndrumare <span className="font-bold uppercase">astromagică</span> pentru o viață armonioasă
        </h4>
