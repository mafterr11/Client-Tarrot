...
const Reviews = () => {
  ...
  return (
    <section className="mx-auto px-5 py-24 max-md:container xl:container max-md:px-0">
      <motion.h2
        variants={fadeIn("down", 0.4)}
        initial="hidden"
        whileInView={"show"}
        viewport={{ once: true, ammount: 0.4 }}
        className="mb-32 text-center underline decoration-accent decoration-4 underline-offset-8"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
        {testimonials.map((testimonial, index) => (
          ...
          >
            {/* c08332 */}
            {/* 634319 */}
            <div className="grid h-[430px] grid-cols-subgrid rounded bg-[#b1983f] p-8 transition-all duration-500 ease-in-out hover:-translate-y-2 hover:scale-[1.02] md:max-xl:mx-auto md:max-xl:w-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="mb-4 block h-5 w-5 text-white"
