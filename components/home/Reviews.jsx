...
const Reviews = () => {
  const testimonials = [
    {
      text: "Edera m-a ajutat să îmi găsesc liniștea interioară și să clarific problemele care mă frământau. Citirile ei de tarot sunt extrem de precise, iar sfaturile ei m-au ajutat să fac alegeri mai bune în viață. Sunt recunoscător pentru tot sprijinul pe care mi l-a oferit.",
      nume: "Alexandru",
        ...
        {testimonials.map((testimonial, index) => (
          ...
          >
            <div className="h-[400px] bg-orange-50 p-8 rounded grid grid-cols-subgrid hover:-translate-y-2 hover:scale-[1.02] transition-all ease-in-out duration-500">
              ...
              <p className="leading-relaxed mb-6 text-neutral-900">
                {testimonial.text}
              </p>
